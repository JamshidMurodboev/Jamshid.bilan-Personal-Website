  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">Bog'lanish</h1>
        <p className="text-gray-600 mb-8">Savol va murojaatlaringiz uchun quyidagi kanallar orqali bog'laning.</p>
