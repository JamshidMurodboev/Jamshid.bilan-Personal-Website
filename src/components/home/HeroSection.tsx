        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center lg:min-h-[calc(100vh-4rem)] pb-16">
          ...
          <div className="flex justify-center lg:justify-end relative">
            <div className="relative">
              ...
              <div className="relative w-full max-w-[288px] h-[360px] sm:w-80 sm:h-[460px] lg:w-[360px] lg:h-[500px] rounded-[2.5rem] overflow-hidden shadow-2xl shadow-black/20 dark:shadow-black/60 border-4 border-white dark:border-gray-800">
