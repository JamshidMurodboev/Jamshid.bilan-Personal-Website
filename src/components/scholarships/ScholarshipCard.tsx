...
const STATUS_COLORS = {
  ...
  coming_soon: 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-400',
};
const STATUS_LABELS = { open: 'Ochiq', closed: 'Yopiq', coming_soon: 'Tez kunda' };
...
export default function ScholarshipCard({ scholarship: s }: { scholarship: Scholarship }) {
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm hover:shadow-md transition flex flex-col gap-3 border border-gray-100 dark:border-gray-700">
      ...
      <p className="text-xs text-gray-500 dark:text-gray-400">Muddati: {new Date(s.deadline).toLocaleDateString('uz-UZ')}</p>
